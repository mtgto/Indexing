...
- (Channel *)channelByComponents:(NSArray *)components yellowPage:(YellowPage *)yellowPage {
    ...
    channel.detailMessage = [components[5] gtm_stringByUnescapingFromHTML];
    ...
    channel.statusMessage = [components[16] gtm_stringByUnescapingFromHTML];
    channel.comment = [components[17] gtm_stringByUnescapingFromHTML];
    return channel;
}
